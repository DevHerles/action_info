odoo.define('info_view.InfoView', function (require) {
    ...
    var InfoView = View.extend({
        ...
        start: function () {
            ...
            this.$field_selection.html(QWeb.render('InfoView.FieldSelection', context));
        ...
        /**
         * Render the buttons according to the InfoView.buttons template and
         * add listeners on it.
         * Set this.$buttons with the produced jQuery element
         * @param {jQuery} [$node] a jQuery node where the rendered buttons should be inserted
         * $node may be undefined, in which case the InfoView does nothing
         */
        render_buttons: function ($node) {
            if ($node) {
                ...
                this.$buttons = $(QWeb.render('InfoView.buttons', context));
        ...
        display_table: function () {
            if (!this.active_measures.length || !this.has_data) {
                return this._clean_table().append(QWeb.render('InfoView.nodata'));
            }
